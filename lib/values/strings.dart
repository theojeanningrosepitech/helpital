...
class StringConst {
  //strings
  static const String APP_NAME = "helpital";
  static const String APP_TITLE = "Helpital";
  static const String SITE_URL = "https://helpital.com";
  ...
  static const String DEV_EMAIL = "theo.jeanningros@gmail.com";
  static const String EMAIL_URL = "mailto:<$DEV_EMAIL>?subject=&body=";

  static const String KEY_SKILLS = "Les Solutions que nous proposons";
...
+ "\nL’ensemble des solutions offertes par Helpital repose sur un logiciel de gestion cross-platform qui propose comme outils : la gestion des consultations, du personnel et des patients mais aussi une messagerie, un plan de l'hôpital et bien plus encore. Autour de cette base gravitent d’autres solutions telles qu' un site de recrutement ainsi qu’un site de prise de rendez-vous qui vous permet de contacter directement le praticien de votre choix.";
  ...
  static const String JAVA = "Disponibilité des machines";
  static const String ANDROID = "Messagerie";
  static const String KOTLIN = "Gestion des chambres des hopitaux";
  static const String JAVASCRIPT = "Annuaire";
  static const String PHP = "Gestion du personnel de l'hopital";
  static const String LARAVEL = "Gestion des consultations et des opérations";
  static const String SQL = "Gestion de l'inventaire";
  static const String WORDPRESS = "Gestion et créations des profiles des patients";
  static const String BOOTSTRAP = "Numérisation des échographie et radiographie";
  static const String HTML_CSS = "Numérisation des plan de l'hopital";
  static const String HTML_CSS2 = "Création d’ordonnances et de note patient";
  static const String HTML_CSS3 = "Numérisation des plan de l'hopital";
  static const String HTML_CSS4 = "Numérisation des plan de l'hopital";
